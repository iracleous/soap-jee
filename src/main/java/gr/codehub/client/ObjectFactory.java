 ...
 * generated in the gr.codehub.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCurrencyById_QNAME = new QName("http://model.codehub.gr/", "getCurrencyById");
    private final static QName _GetCurrencyByIdResponse_QNAME = new QName("http://model.codehub.gr/", "getCurrencyByIdResponse");
    private final static QName _GetAllCurrencies_QNAME = new QName("http://model.codehub.gr/", "getAllCurrencies");
    private final static QName _SaveResponse_QNAME = new QName("http://model.codehub.gr/", "saveResponse");
    private final static QName _DeleteById_QNAME = new QName("http://model.codehub.gr/", "deleteById");
    private final static QName _Save_QNAME = new QName("http://model.codehub.gr/", "save");
    private final static QName _FindByCodeResponse_QNAME = new QName("http://model.codehub.gr/", "findByCodeResponse");
    private final static QName _DeleteByIdResponse_QNAME = new QName("http://model.codehub.gr/", "deleteByIdResponse");
    private final static QName _GetAllCurrenciesResponse_QNAME = new QName("http://model.codehub.gr/", "getAllCurrenciesResponse");
    private final static QName _FindByCode_QNAME = new QName("http://model.codehub.gr/", "findByCode");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: gr.codehub.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "getCurrencyById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "getCurrencyByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "getAllCurrencies")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "saveResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "deleteById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "save")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "findByCodeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "deleteByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "getAllCurrenciesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model.codehub.gr/", name = "findByCode")
